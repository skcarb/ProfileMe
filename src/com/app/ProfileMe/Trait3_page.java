...
public class Trait3_page extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_trait_three);
		App_constants.trait_selected = 3;
		setBodyUI();
		getDimension();
		setImage();
...
/*	
	private void imageChanged() {
		// TODO Auto-generated method stub
		image_one=Trait1_page.reduceImageSize(image_one);
		image_two=Trait1_page.reduceImageSize(image_two);
		image_three=Trait1_page.reduceImageSize(image_three);
	
		opt_one.setImageBitmap(image_one);
		opt_two.setImageBitmap(image_two);
		opt_three.setImageBitmap(image_three);
		opt_one.setScaleType(ScaleType.FIT_XY);
		opt_two.setScaleType(ScaleType.FIT_XY);
		opt_three.setScaleType(ScaleType.FIT_XY);
	...
	public void new_login(){
		if(Welcome_page.facebookConnector.getFacebook().isSessionValid()){
			...
			Toast.makeText(Trait3_page.this,
					"No Session...Trying for Session", Toast.LENGTH_LONG)
					.show();
			Welcome_page.facebookConnector.getFacebook().authorize(Trait3_page.this, FacebookConstant.PERMISSIONS, new LoginDialogListener());
		}
	...
	private class FacebookLogin extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			progress = ProgressDialog.show(Trait3_page.this, "",
					"processing....");
		}
		...
		protected void onPostExecute(String result) {
			...
			startActivity(new Intent(getApplicationContext(), Trait3_page.class));
			finish();

			} else {
				System.out.println("else=======================");
				Toast.makeText(Trait3_page.this, " No Response.",Toast.LENGTH_LONG).show();
			}
			progress.dismiss();
		}
	}
	...
	private final class ResponseListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			AlertDialog.Builder alert = new AlertDialog.Builder(Trait3_page.this);
			alert.setTitle("Enter Text For Post");
			alert.setMessage("Post Message");
			// Set an EditText view to get user input
			final EditText input = new EditText(Trait3_page.this);
			input.setHeight(140);
	...
	private void setImage() {
		...
		{
			opt_one.setBackgroundResource(R.drawable.newsix_full);
			opt_two.setBackgroundResource(R.drawable.two_full);
			opt_three.setBackgroundResource(R.drawable.seven_full);

		}
		else{
			opt_one.setBackgroundResource(R.drawable.five_full);
			opt_two.setBackgroundResource(R.drawable.newone_full);
			opt_three.setBackgroundResource(R.drawable.eight_full);
	...
	private void setBodyUI() {
		...
		full_image = (ImageView) findViewById(R.id.imageView1);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btn_back:
			i.setClass(Trait3_page.this, Welcome_page.class);
			startActivity(i);
			Trait3_page.this.finish();

			break;

		case R.id.btn_pre:
			i.setClass(Trait3_page.this, Trait2_page.class);
			startActivity(i);
			Trait3_page.this.finish();

			break;
		case R.id.btn_video:
			App_constants.trait_count = 3;
			i.setClass(Trait3_page.this, Video_play.class);
			startActivity(i);
			Trait3_page.this.finish();
		...
		case R.id.btn_description:
			App_constants.trait_count = 3;
			i.setClass(Trait3_page.this, Trait_desc.class);
			startActivity(i);
			Trait3_page.this.finish();
			break;
		case R.id.btn_next:
			if (select_image == true) {
				i.setClass(Trait3_page.this, Trait4_page.class);
				startActivity(i);
				Trait3_page.this.finish();
			} else {
				Toast toast=Toast.makeText(Trait3_page.this, "Please select the third trait", Toast.LENGTH_SHORT);
		...
		case R.id.btn_howItWork:
			...
			i.setClass(Trait3_page.this, How_it_Works.class);
			startActivity(i);
			Trait3_page.this.finish();

			break;
		case R.id.btn_more:
			i.setClass(Trait3_page.this, UpSell.class);
			startActivity(i);
			Trait3_page.this.finish();
		...
		case R.id.image_optn1:
			select_image = true;
			i.setClass(Trait3_page.this, Image_full.class);
			startActivity(i);
			Trait3_page.this.finish();
			App_constants.trait_three = 1;
	...
	case R.id.ll_three:
		...
		//adapter3 = new SocialAuthAdapter(new ResponseListener());
