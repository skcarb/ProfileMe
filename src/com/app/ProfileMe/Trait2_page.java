...
public class Trait2_page extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_trait_two);
		App_constants.trait_selected=2;
		setBodyUI();
		getDimension();
		setImage();
	...
	public void new_login(){
		if(Welcome_page.facebookConnector.getFacebook().isSessionValid()){
			...
			Toast.makeText(Trait2_page.this,
					"No Session...Trying for Session", Toast.LENGTH_LONG)
					.show();
			Welcome_page.facebookConnector.getFacebook().authorize(Trait2_page.this, FacebookConstant.PERMISSIONS, new LoginDialogListener());
		}
	...
	private class FacebookLogin extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			progress = ProgressDialog.show(Trait2_page.this, "",
					"processing....");
		}
		...
		protected void onPostExecute(String result) {
			...
			startActivity(new Intent(getApplicationContext(), Trait2_page.class));
			finish();

			} else {
				System.out.println("else=======================");
				Toast.makeText(Trait2_page.this, " No Response.",Toast.LENGTH_LONG).show();
			}
			progress.dismiss();
		}
	}
	...
	private void setImage() {
		...
		{
			opt_one.setBackgroundResource(R.drawable.three_full);
			opt_two.setBackgroundResource(R.drawable.neweight_full);
			opt_three.setBackgroundResource(R.drawable.newseven_full);

		}
		else{
			opt_one.setBackgroundResource(R.drawable.four_full);
			opt_two.setBackgroundResource(R.drawable.ten_full);
			opt_three.setBackgroundResource(R.drawable.newfive_full);
	...
	private final class ResponseListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			AlertDialog.Builder alert = new AlertDialog.Builder(Trait2_page.this);
			alert.setTitle("Enter Text For Post");
			alert.setMessage("Post Message");
			// Set an EditText view to get user input
			final EditText input = new EditText(Trait2_page.this);
			input.setHeight(140);
	...
	private void setBodyUI() {
		...
		//findViewById(R.id.btn_welcome).setBackgroundResource(R.drawable.bottommenuwelcomeactive);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btn_back:
			i.setClass(Trait2_page.this, Welcome_page.class);
			startActivity(i);
			Trait2_page.this.finish();
			
			break;

		case R.id.btn_pre:
			i.setClass(Trait2_page.this, Trait1_page.class);
			startActivity(i);
			Trait2_page.this.finish();
			
			break;
		case R.id.btn_video:
			App_constants.trait_count=2;
		
			i.setClass(Trait2_page.this, Video_play.class);
			startActivity(i);
			Trait2_page.this.finish();
		...
		case R.id.btn_description:
			App_constants.trait_count=2;
			i.setClass(Trait2_page.this, Trait_desc.class);
			startActivity(i);
			Trait2_page.this.finish();
		...
		case R.id.btn_next:
			...
			{
				i.setClass(Trait2_page.this, Trait3_page.class);
				startActivity(i);
				Trait2_page.this.finish();
			}
			else{
				Toast toast=Toast.makeText(Trait2_page.this, "Please select the second trait", Toast.LENGTH_SHORT);
	...
	case R.id.btn_welcome:
		...
		case R.id.btn_tellAFriend:
			...
			//findViewById(R.id.btn_tellAFriend).setBackgroundResource(R.drawable.tellafriendactive);
		...
		case R.id.btn_howItWork:
			...
			i.setClass(Trait2_page.this, How_it_Works.class);
			startActivity(i);
			Trait2_page.this.finish();
			
			break;
		case R.id.btn_more:
			i.setClass(Trait2_page.this, UpSell.class);
			startActivity(i);
			Trait2_page.this.finish();
		...
		case R.id.image_optn1:
			seltect_image=true;
			i.setClass(Trait2_page.this, Image_full.class);
			startActivity(i);
			Trait2_page.this.finish();
			App_constants.trait_two=1;
