...
public class Trait5_page extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_trait_five);
		App_constants.trait_selected=5;
		setBodyUI();
		getDimension();
		setImage();
	...
	public void new_login(){
		if(Welcome_page.facebookConnector.getFacebook().isSessionValid()){
			...
			Toast.makeText(Trait5_page.this,
					"No Session...Trying for Session", Toast.LENGTH_LONG)
					.show();
			Welcome_page.facebookConnector.getFacebook().authorize(Trait5_page.this, FacebookConstant.PERMISSIONS, new LoginDialogListener());
		}
	...
	private class FacebookLogin extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			progress = ProgressDialog.show(Trait5_page.this, "",
					"processing....");
		}
		...
		protected void onPostExecute(String result) {
			...
			startActivity(new Intent(getApplicationContext(), Trait5_page.class));
			finish();

			} else {
				System.out.println("else=======================");
				Toast.makeText(Trait5_page.this, " No Response.",Toast.LENGTH_LONG).show();
			}
			progress.dismiss();
		}
	}
	...
	private final class ResponseListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			*/
			AlertDialog.Builder alert = new AlertDialog.Builder(Trait5_page.this);

			alert.setTitle("Enter Text For Post");
			alert.setMessage("Post Message");

			// Set an EditText view to get user input
			final EditText input = new EditText(Trait5_page.this);
			input.setHeight(140);
	...
	private void setImage() {
		...
		{
			opt_one.setBackgroundResource(R.drawable.newten_full);
			opt_two.setBackgroundResource(R.drawable.seven_full);
			opt_three.setBackgroundResource(R.drawable.two_full);

		}
		else{
			opt_one.setBackgroundResource(R.drawable.ten_full);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btn_back:
			i.setClass(Trait5_page.this, Welcome_page.class);
			startActivity(i);
			Trait5_page.this.finish();
			
			break;

		case R.id.btn_pre:
			i.setClass(Trait5_page.this, Trait4_page.class);
			startActivity(i);
			Trait5_page.this.finish();
			
			break;
		case R.id.btn_video:
			App_constants.trait_count=5;
			i.setClass(Trait5_page.this, Video_play.class);
			startActivity(i);
			Trait5_page.this.finish();
		...
		case R.id.btn_description:
			App_constants.trait_count=5;
			i.setClass(Trait5_page.this, Trait_desc.class);
			startActivity(i);
			Trait5_page.this.finish();
			break;
		case R.id.btn_next:
			...
			{
				i.setClass(Trait5_page.this, Trait6_page.class);
				startActivity(i);
				Trait5_page.this.finish();
			}
			else{
				Toast toast=Toast.makeText(Trait5_page.this, "Please select the fifth trait", Toast.LENGTH_SHORT);
	...
	case R.id.btn_welcome:
		...
		case R.id.btn_howItWork:
			...
			i.setClass(Trait5_page.this, How_it_Works.class);
			startActivity(i);
			Trait5_page.this.finish();
			
			break;
		case R.id.btn_more:
			i.setClass(Trait5_page.this, UpSell.class);
			startActivity(i);
			Trait5_page.this.finish();
		...
		case R.id.image_optn1:
			select_image=true;
			i.setClass(Trait5_page.this, Image_full.class);
			startActivity(i);
			Trait5_page.this.finish();
			App_constants.trait_five=1;
