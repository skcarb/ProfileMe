...
public class Trait4_page extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_trait_four);
		App_constants.trait_selected=4;
		setBodyUI();
		getDimension();
		setImage();
	...
	public void new_login(){
		if(Welcome_page.facebookConnector.getFacebook().isSessionValid()){
			...
			Toast.makeText(Trait4_page.this,
					"No Session...Trying for Session", Toast.LENGTH_LONG)
					.show();
			Welcome_page.facebookConnector.getFacebook().authorize(Trait4_page.this, FacebookConstant.PERMISSIONS, new LoginDialogListener());
		}
	...
	private class FacebookLogin extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			progress = ProgressDialog.show(Trait4_page.this, "",
					"processing....");
		}
		...
		protected void onPostExecute(String result) {
			...
			startActivity(new Intent(getApplicationContext(), Trait4_page.class));
			finish();

			} else {
				System.out.println("else=======================");
				Toast.makeText(Trait4_page.this, " No Response.",Toast.LENGTH_LONG).show();
			}
			progress.dismiss();
		}
	}
	...
	private final class ResponseListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			AlertDialog.Builder alert = new AlertDialog.Builder(Trait4_page.this);

			alert.setTitle("Enter Text For Post");
			alert.setMessage("Post Message");

			// Set an EditText view to get user input
			final EditText input = new EditText(Trait4_page.this);
			input.setHeight(140);
	...
	private void setImage() {
		...
		{
			opt_one.setBackgroundResource(R.drawable.two_full);
			opt_two.setBackgroundResource(R.drawable.newfour_full);
			opt_three.setBackgroundResource(R.drawable.newten_full);

		}
		else{
			opt_one.setBackgroundResource(R.drawable.newtwo_full);
			opt_two.setBackgroundResource(R.drawable.nine_full);
			opt_three.setBackgroundResource(R.drawable.one_full);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btn_back:
			i.setClass(Trait4_page.this, Welcome_page.class);
			startActivity(i);
			Trait4_page.this.finish();
			
			break;

		case R.id.btn_pre:
			i.setClass(Trait4_page.this, Trait3_page.class);
			startActivity(i);
			Trait4_page.this.finish();
			
			break;
		case R.id.btn_video:
			App_constants.trait_count=4;
			i.setClass(Trait4_page.this, Video_play.class);
			startActivity(i);
			Trait4_page.this.finish();
		...
		case R.id.btn_description:
			App_constants.trait_count=4;
			i.setClass(Trait4_page.this, Trait_desc.class);
			startActivity(i);
			Trait4_page.this.finish();
		...
		case R.id.btn_next:
			...
			{
				i.setClass(Trait4_page.this, Trait5_page.class);
				startActivity(i);
				Trait4_page.this.finish();
			}
			else{
				Toast toast=Toast.makeText(Trait4_page.this, "Please select the fourth trait", Toast.LENGTH_SHORT);
	...
	case R.id.btn_welcome:
		...
		case R.id.btn_howItWork:
			...
			i.setClass(Trait4_page.this, How_it_Works.class);
			startActivity(i);
			Trait4_page.this.finish();
		...
		case R.id.btn_more:
			i.setClass(Trait4_page.this, UpSell.class);
			startActivity(i);
			Trait4_page.this.finish();
		...
		case R.id.image_optn1:
			select_image=true;
			i.setClass(Trait4_page.this, Image_full.class);
			startActivity(i);
			Trait4_page.this.finish();
			App_constants.trait_four=1;
